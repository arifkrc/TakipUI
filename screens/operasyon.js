import { createRowCountSelector, createPaginationControls, showToast, showFormErrors, clearFormErrors } from '../ui/helpers.js';
let _cleanup = null;
...
export async function mount(container, { setHeader }) {
  ...
  // State for showing inactive operations
  ...
  async function submitHandler(e) {
    ...
    try {
      // API payload format - sadece name ve shortCode
      const payload = {
      ...
      console.log('📥 CREATE OPERATION RESPONSE:');
  ...
  async function loadList() {
    placeholder.innerHTML = '<div class="p-4 text-neutral-400">Yükleniyor...</div>';
